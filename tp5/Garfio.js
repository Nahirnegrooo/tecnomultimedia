class Garfio {
  ...
  dibujar() {
    if (this.vida > 0) {
      ...
      // El personaje está muerto, puedes realizar alguna acción o mostrar un mensaje de game over
    }
  }
  ...
  mover() {
    ...
    // Cambia la dirección si Garfio llega a los límites
    if (this.posX >= width - this.tamX || this.posX <= 0) {
