...
void draw(){
   ...
   dibujarTexto( 100, 510,150,70, "INICIO----" ); 
    ...
    if ( dist(mouseX, mouseY, 200, 550)<=50 ) {    // programo un boton 
      fill( 200, 0, 0 );
    } else {
      fill( 200 );
    }
  ...
  dibujarTexto(20, 250, 500, 600, texto[1]);
      ...
      if (pantallaActual >= 3 && pantallaActual < imagen.length) {   //P3 (aca se elige una opcion) 
    image(imagen[3], 0, 0);  
 dibujarTexto( 30, 30, 400,100, "Se dirigen a la ventana. Elija una opcion" );
 
 if ( dist(mouseX, mouseY, 90, 550)<=50 ) {    // programo un boton 
      fill( 200, 0, 0 );
    } else {
      fill( 200 );
    }
    circle( 90, 550, 50 );  
if ( dist(mouseX, mouseY, 490, 550)<=50 ) {    // programo un boton 
      fill( 200, 0, 0 );
    } else {
      fill( 200 );
    }
    circle( 490, 550, 50 );  
         ...
         if (pantallaActual >= 4 && pantallaActual < imagen.length) { //P4 FINAL 1 tecla de reinicio
    image(imagen[4], 0, 0);
    ...
    dibujarTexto(20, 150, 500, 600, texto[5]);
      ...
      if (pantallaActual >= 8 && pantallaActual < imagen.length) {//P8 aca hay que elegir una opcion
    image(imagen[8], 0, 0);

    dibujarTexto( 30, 30, 400,100, "Peter se enferenta con el capitan Garfio. \n Elija una opcion" );        

 if ( dist(mouseX, mouseY, 390, 490)<=50 ) {    // programo un boton 
      fill( 200, 0, 0 );
    } else {
      fill( 200 );
    }
...
if ( dist(mouseX, mouseY, 220, 490)<=50 ) {    // programo un boton 
      fill( 200, 0, 0 );
    } else {
      fill( 200 );
    }
...
if ( dist(mouseX, mouseY, 150, 350)<=50 ) {    // programo un boton 
      fill( 200, 0, 0 );
    } else {
      fill( 200 );
    }
...
if ( dist(mouseX, mouseY, 75, 460)<=50 ) {    // programo un boton 
      fill( 200, 0, 0 );
    } else {
      fill( 200 );
    }
...
void mousePressed() {  
 ...
 if ( pantallaActual == 0 && estoyDentroDeZonaCircular(200,550,50) ) {
    pantallaActual = 1;
   } 
 ...
 }else if (pantallaActual ==3 && estoyDentroDeZonaCircular(90,550,50)) {
    pantallaActual = 4; 
  } else if (pantallaActual ==3 && estoyDentroDeZonaCircular(490,550,50)) {
    pantallaActual = 5; 
      ...
      pantallaActual=8;
      } else if (pantallaActual ==8 && estoyDentroDeZonaCircular(390,490,50)) {
    pantallaActual = 9;
      }else if (pantallaActual ==8 && estoyDentroDeZonaCircular(220,490,50)) {
    pantallaActual = 12;
  ...
  pantallaActual=15;
}else if (pantallaActual ==15 && estoyDentroDeZonaCircular(150,350,50)){
    pantallaActual=16;
}else if (pantallaActual ==15 && estoyDentroDeZonaCircular(75,460,50)){
pantallaActual=17;
}
}
void keyPressed() {
